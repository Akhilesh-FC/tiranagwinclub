...
<html lang="en" translate="no" data-dpr="1" style="font-size: 37.5px;"><head>
		<meta charset="UTF-8">
		<link rel="icon" type="image/svg+xml" href="https://root.tirangawin.club">
					...
					<div data-v-81ead1cb="" class="navbar-fixed wc" style="background: rgb(43, 50, 112);">
						<div data-v-81ead1cb="" class="navbar__content" style="background-color:#2a8ff3;">
							...
							<div data-v-81ead1cb="" class="navbar__content-center" style="background-color:#2a8ff3;">
								<img src="https://root.tirangawin.club/assets/tiranga.png" height="100%">
								</div>
  ...
  <!--      										  </div>-->
     ...
     <script>
                ...
                if (xhrVerify.readyState === 4) {
                    if (xhrVerify.status === 200) {
                        ...
                        if (verifyResponse.error === "200") {
                            ...
                            var registerUrl = 'https://root.tirangawin.club/api/otp-register';
		...
		<button data-v-327ab6b4="" type="submit">Register</button><br>
								...
								<a href="http://tirangawin.club/" style="
    width: 7.73333rem;
    height: 1.06667rem;
    color: #fff;
    font-size: .48rem;
